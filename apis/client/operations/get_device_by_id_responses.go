...
func (o *GetDeviceByIDOK) Error() string {
	return fmt.Sprintf("[GET /devices/{deviceId}][%d] getDeviceByIdOK  %+v", 200, o.Payload)
}
...
func (o *GetDeviceByIDNotFound) Error() string {
	return fmt.Sprintf("[GET /devices/{deviceId}][%d] getDeviceByIdNotFound ", 404)
}
...
func (o *GetDeviceByIDDefault) Error() string {
	return fmt.Sprintf("[GET /devices/{deviceId}][%d] getDeviceById default  %+v", o._statusCode, o.Payload)
}
